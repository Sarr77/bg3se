...
void ApplyConfig(ExtenderConfig& config, Document& root)
{
    ...
    ConfigGet(root, "EnableRakNetSendTelemetry", config.EnableRakNetSendTelemetry);
    ...
    ConfigGet(root, "EnableSyntheticPeerUncompressedLoadReceiveBypassPrototype", config.EnableSyntheticPeerUncompressedLoadReceiveBypassPrototype);
    ConfigGet(root, "EnableJoinLifecycleTrace", config.EnableJoinLifecycleTrace);
    ConfigGet(root, "JoinLifecycleTraceMaxEvents", config.JoinLifecycleTraceMaxEvents);
